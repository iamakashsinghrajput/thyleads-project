...
export default function SeriesACTA() {
  return (
    <section className="relative py-20 lg:py-28 px-6 sm:px-12 overflow-hidden bg-primary-700 font-sans">
      ...
      >
        ...
        >
          Ready to build the first pipeline for{' '}
          <span className="text-primary-100">your SaaS?</span>
        </motion.h2>
        ...
        >
          Stop burning runway on guesswork. Let&apos;s build a repeatable
          outbound engine together.
        </motion.p>
