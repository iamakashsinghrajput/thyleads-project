...
const leads: Lead[] = [
  {
    ...
    message:
      'Hey Sneha — noticed NorthScale just hired three SDRs after the Series B. We help SaaS teams ramp pipeline in 30 days. Worth a 15-min look?',
  },
  {
    initials: 'AK',
    name: 'Arjun Kapoor',
    ...
    icpScore: 91,
    intent: 'High',
    signals: ['New funding', 'Market entry', 'GTM rebuild'],
    message:
      'Hi Arjun — saw FlowMetrics is building out the GTM motion. We run outbound for SaaS expanding here. 15 mins next week?',
  },
  {
    initials: 'PR',
    name: 'Priya Reddy',
    ...
    message:
      'Priya — you mentioned filling pipeline gaps in your last podcast. We do exactly this for SaaS teams. Quick chat?',
  },
];
...
export default function PipelineDiagram() {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        aria-hidden="true"
        className="absolute -top-12 -right-12 w-72 h-72 bg-transparent blur-3xl rounded-full pointer-events-none"
      />
      <div
        aria-hidden="true"
