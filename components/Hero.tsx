      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] font-black text-white/60 uppercase tracking-[0.3em]">India GTM for SaaS</span>
          </motion.div>
          ...
          >
            We help global SaaS companies build and convert Indian demand through outbound, inbound qualification, and deal momentum.
          </motion.p>
