...
const caseStudies: CaseStudy[] = [
  ...
  },
  {
    brand: 'VWO',
    logo: '/images/VWO.svg',
    title: 'Turning cold prospects into high-intent enterprise partners',
    description:
      'To scale their enterprise presence, VWO needed an outbound motion that matched their product’s sophistication, a system that could prove a tech stack without VWO is a stack incomplete. Thyleads didn’t treat this as a lead-gen project; we changed the entire entry point into VWO’s target accounts.',
    stats: [
      { value: '40+', label: 'Net-new appointments in 90 days' },
      { value: '11', label: 'Dormant enterprise accounts revived' },
      { value: '6', label: 'Pilot programs launched' },
    ],
  },
];

export default function SeriesBSocialProof() {
  return (
