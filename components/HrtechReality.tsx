...
import { ScanSearch, MessageSquareDashed, GitFork } from 'lucide-react';
...
const walls = [
  {
    ...
    description:
      'Not every HR team is a real buyer even if they look like one. Without a defined ICP, your team ends up chasing leads that go nowhere.',
    accent: 'ICP fit < 15%',
  },
  {
  ...
  },
  {
    ...
    description:
      'A single HRTech deal touches CHRO, CEO, HR Managers, and CIO, each with different priorities. Buyers are demo-fatigued, decisions drag, and single-threaded outreach dies in the approval chain.',
    accent: '4+ stakeholders',
  },
];

export default function HrtechReality() {
  return (
    <section className="relative py-16 lg:py-24 px-6 sm:px-12 overflow-hidden bg-white font-sans">
      ...
      >
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            The buying committee is sprawling and HR teams are fatigued by
            demos. Generic outbound playbooks built for CRM or DevTools
            don&apos;t translate.
          </motion.p>
        </div>
