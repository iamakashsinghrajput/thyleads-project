...
const faqs: FAQ[] = [
  {
    question:
      'How do you avoid pitching the same "AI-powered outbound" every other vendor uses?',
    answer:
  ...
  {
    question: 'Do you guarantee exclusivity within MarTech sub-categories?',
    answer:
      'Yes. We don’t run outbound for two directly competing MarTech products at the same time. If we’re working with you on customer engagement, we won’t take on a competing CEP. This is core to how we operate across all verticals.',
  },
  {
    question: 'How do you ensure we get qualified, high-intent leads?',
    answer:
      'We track buying signals and research accounts across channels to identify teams actively evaluating MarTech solutions. By understanding how marketing leaders think and buy, we ensure only relevant, high-converting opportunities reach your team.',
  },
];
    ...
    <section className="relative py-16 lg:py-24 px-6 sm:px-12 overflow-hidden bg-white font-sans">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          >
            The questions that come up on every MarTech discovery call.
          </motion.p>
        </div>
